...
class Log(object):
    ...
    def filter_path(self, qs, path=None, field="unit__store__xtle_path"):
        return (
    ...
    def filter_timestamps(self, qs, start=None, end=None,
                          field="creation_time"):
