...
from xtle.core.user import get_system_user
...
from xtle.store.constants import FUZZY, TRANSLATED
...
class Submission(models.Model):
    ...
    suggestion = models.ForeignKey('xtle_store.Suggestion', blank=True,
    ...
    unit = models.ForeignKey(
        ...
        db_index=True,
        on_delete=models.CASCADE)
    quality_check = models.ForeignKey('xtle_store.QualityCheck', blank=True,
                                      null=True, db_index=True,
                                      on_delete=models.CASCADE)
    ...
    # functions in xtle_store.fields to convert to and from this format.
            ...
            if self.quality_check is not None:
                ...
                result.update({
                    ...
                    'check_display_name': CHECK_NAMES.get(check_name,
                                                          check_name),
                    'checks_url': reverse('xtle-checks-descriptions'),
                })
