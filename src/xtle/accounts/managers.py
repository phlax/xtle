...
from xtle.app.models.permissions import check_user_permission
...
class UserManager(BaseUserManager):
    ...
    def get_users_with_permission(self, permission_code, project, language,
        ...
        user_filter &= (
            Q(permissionset__directory__xtle_path=directory.xtle_path)
            | Q(permissionset__directory__xtle_path=language.xtle_path)
            | Q(permissionset__directory__xtle_path=project.xtle_path)
        )
