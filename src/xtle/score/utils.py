...
from xtle.core.delegate import display, revision, scores
from xtle.core.utils.timezone import localdate, make_aware
from xtle.app.models import Directory
from xtle.language.models import Language

from .apps import XTLEScoreConfig
...
class Scores(object):
    ns = "xtle.score"
    sw_version = XTLEScoreConfig.version
