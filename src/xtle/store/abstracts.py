...
from xtle.core.user import get_system_user, get_system_user_id
...
class AbstractStore(models.Model, CachedTreeItem, base.TranslationStore):
    ...
    translation_project_fk = 'xtle_tp.TranslationProject'
    ...
    class Meta(object):
        ...
        index_together = [
            ...
            ["translation_project", "xtle_path", "is_template", "filetype"]]
        unique_together = (
            ('parent', 'name'),
...
class AbstractSuggestion(models.Model, base.TranslationUnit):
    ...
    unit = models.ForeignKey('xtle_store.Unit', on_delete=models.CASCADE)
