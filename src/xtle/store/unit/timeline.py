...
from xtle.accounts.proxy import DisplayUser
from xtle.core.delegate import event_formatters, grouped_events
from xtle.core.proxy import BaseProxy
from xtle.i18n.gettext import ugettext_lazy as _
from xtle.checks.constants import CHECK_NAMES
from xtle.comment import get_model as get_comment_model
from xtle.log.utils import GroupedEvents, UnitLog
from xtle.statistics.models import (
    Submission, SubmissionFields, SubmissionTypes)
from xtle.store.constants import STATES_MAP
from xtle.store.fields import to_python
from xtle.store.models import Suggestion
...
class CheckEvent(SubmissionEvent):
    ...
    def check_url(self):
        return u''.join(
            [reverse('xtle-checks-descriptions'),
             '#', self.check_name])
