...
from xtle.core.delegate import revision
from xtle.core.signals import update_data
from xtle.data.models import StoreChecksData, StoreData
...
class TPDataTool(RelatedStoresDataTool):
    ...
    def context_name(self):
        return self.context.xtle_path.strip("/").replace("/", ".")
