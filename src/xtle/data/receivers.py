...
from xtle.core.delegate import crud, data_tool, data_updater
from xtle.core.signals import create, delete, update, update_data
...
def handle_store_data_create(sender, instance, created, **kwargs):
    if created:
        data_updater.get(
            instance.data_tool.__class__)(instance.data_tool).update()
