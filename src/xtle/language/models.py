...
from xtle.core.delegate import data_tool, language_code, site_languages
from xtle.core.mixins import TreeItem
from xtle.core.url_helpers import get_editor_filter
from xtle.i18n.gettext import language_dir, tr_lang, ugettext_lazy as _
...
class Language(models.Model, TreeItem):
    ...
    directory = models.OneToOneField('xtle_app.Directory', db_index=True,
    ...
    def get_absolute_url(self):
        return reverse('xtle-language-browse', args=[self.code])

    def get_translate_url(self, **kwargs):
        return u''.join([
            reverse('xtle-language-translate', args=[self.code]),
