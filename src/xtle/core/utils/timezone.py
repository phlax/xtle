...
def aware_datetime(*args, **kwargs):
    ...
    :param tz: timezone in which the `datetime` should be constructed. Note
        that this bypasses passing `tzinfo` to the `datetime` constructor, as
        it is known not to play well with DST (unless only UTC is used).
    """
