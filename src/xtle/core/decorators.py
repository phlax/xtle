...
from .url_helpers import split_xtle_path
...
def get_path_obj(func):
    ...
    from xtle_translationproject.models import TranslationProject
            ...
            if path_obj is None:
                if not request.is_ajax():
                    ...
                    if user_choice and user_choice in ('language', 'project',):
                        url = {
                            'language': reverse('xtle-language-browse',
                                                args=[language_code]),
                            'project': reverse('xtle-project-browse',
                                               args=[project_code, '', '']),
                        }
...
class persistent_property(object):
    ...
    def _get_cache_key(self, instance):
        ns = getattr(instance, self.ns_attr, "xtle.core")
