...
import {UserTeamsFieldset} from "./teams";
...
export class BaseUserTeamsAdmin extends React.PureComponent {
...
export const UserTeamsAdmin = injectIntl(BaseUserTeamsAdmin);
