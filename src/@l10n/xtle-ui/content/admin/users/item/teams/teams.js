...
const translation = defineMessages({
    addTeams: {
        id: "xtle.user.add.teams",
        defaultMessage: "Add teams to the user"
    },
});
...
export class BaseUserTeamsFieldset extends React.PureComponent {
...
export const UserTeamsFieldset = injectIntl(BaseUserTeamsFieldset);
