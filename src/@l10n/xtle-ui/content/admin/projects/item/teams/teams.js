...
const translation = defineMessages({
    addTeams: {
        ...
        defaultMessage: "Add teams to the project"
    },
});
...
export class BaseProjectTeamsFieldset extends React.Component {
...
export const ProjectTeamsFieldset = injectIntl(BaseProjectTeamsFieldset);
